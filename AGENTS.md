# opnConfigGenerator - AI Coding Assistant Rules
...
- **Focus on Value**: Enhance the project's unique value as a network configuration mocking tool, providing realistic and useful mock configurations, as part of the [opnDossier](https://opndossier.com) ecosystem
